...
You just earned the Google Business Intelligence career certificate.
This is a huge accomplishment that shows that you're invested in learning new skills for your future.
Now that you are certified in business intelligence, your certificate can be displayed on job search platforms such as LinkedIn, Indeed, and Glassdoor.
Also, be sure to connect with companies that are eager to hire in your field through Grow with Google's Employer Consortium.
...
Get out there and make an impact in the world of business intelligence! 


# PROGRAM WRAP-UP

## Congratulations on completing the Google Business Intelligence Certificate!

It's been wonderful leading you through the final part of this program.
I know you're well-prepared for a fantastic career.
All of us have been so happy to share this journey with you and can't wait to welcome you to the world of BI.
Congratulations. You've done a great job.
Congratulations! I'm so proud of you.
Congratulations.
Felicidades. Estoy súper emocionada por ti, no puedo creer que has llegado hasta acá.
Ahora, es hora de trabajar.
Congratulations. You completed the program.
So fantastic that you finished the program. Congrats!
Congratulations on making it through this course.
You've done an amazing job, and I think you're set up for success.
Great job.
Awesome! You did it!

All that's left to do is collect your Google Business Intelligence Certificate, which you can display on your resume and LinkedIn profile. This certificate represents all the hard work you put into completing this program.
You've accomplished a tremendous amount and shown serious dedication to the field. So stay curious. After all, the learning doesn't stop here. As you enter this new era, be sure to keep up with BI trends, connect with colleagues, keep updating your career materials. For now, take some time to celebrate your achievement. You've earned it. 

## Showcase your work

Congratulations on earning your Google Business Intelligence Certificate! Now it’s time to let the world know about the skills you gained to help advance your career and share some of the artifacts you created along the way. We recommend adding the completion of this certificate to your resume and LinkedIn profile. Read on and follow these tips to get started.

Add the Google Business Intelligence Certificate to your resume and LinkedIn®  profile.

You may have already started on a business intelligence resume earlier in the certificate. If not, there are a variety of digital templates for creating your resume available at Enhancv, Big Interview, Google Docs or Microsoft Word. You can find additional resume creation guidance in this lesson from the Applied Digital Skills: Start a Resume guide.
...
Review this example of how you might format your education on your resume: 

    Google Business Intelligence Certificate, Coursera 2023; Associate of arts, KC Community College, Central, IL 2018

Update your Skills section:

    If applicable, update the Skills section of your resume. 
...
Update your Summary or About section:
    ...
    If you have a Summary section in your resume, you can include this certificate as a qualification.

    To include a summary that mentions this certificate in your LinkedIn®  profile, update your About section by following the steps listed in this article.

Here is an example of a professional summary:

    Entry-level business intelligence professional seeking a full-time role in BI. Recently completed the Google Business Intelligence Professional Certificate—a multi-month BI program that covers managing data retrieval; organizing data; interpreting data in different ways to fit the problem at hand; and creating data visualizations, dashboards, and other tools to provide stakeholder-ready insights.

Add your badge:
    Check out the next course item to learn how to claim your certificate completion badge and add it to your LinkedIn® profile!


## FINAL GLOSSARY

### A
Accuracy: An element of quality testing used to confirm that data conforms to the actual
entity being measured or described
...
Audience problem: A dashboard issue caused by failing to adequately consider the needs of
the user
...
Encoding: The process of translating dimensions and measures into visual representations of
the data
...
objects
Object-level permission: A privacy setting that controls the availability of a single item in a
dashboard
...
Pre-aggregation: The process of performing calculations on data while it is still in the
database
...
Row-level permission: A privacy setting that controls the availability of specific rows of a
table or dataset in a dashboard
...
Trade-off: Balancing various factors, often by prioritizing one element while sacrificing
another, in order to arrive at the best possible result
